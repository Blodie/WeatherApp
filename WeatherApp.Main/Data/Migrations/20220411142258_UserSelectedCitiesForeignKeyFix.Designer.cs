...
namespace WeatherApp.Main.Data.Migrations
{
    ...
    [Migration("20220411142258_UserSelectedCitiesForeignKeyFix")]
    partial class UserSelectedCitiesForeignKeyFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeatherApp.Main.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WeatherApp.Main.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WeatherApp.Main.Data.Models.CurrentWeather", b =>
                {
                    b.HasOne("WeatherApp.Main.Data.Models.City", "City")
                        .WithOne("CurrentWeather")
                        .HasForeignKey("WeatherApp.Main.Data.Models.CurrentWeather", "CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WeatherApp.Main.Data.Models.UserSelectedCity", b =>
                {
                    b.HasOne("WeatherApp.Main.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("UserSelectedCities")
            ...
            modelBuilder.Entity("WeatherApp.Main.Data.Models.ApplicationUser", b =>
                {
                    b.Navigation("UserSelectedCities");
                });
